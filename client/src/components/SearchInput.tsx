...
export const SearchInput = ({ searchInputVisible, toogleSearchInput }: SearchInputProps) => {
    ...
    return <div className={`flex items-center justify-end gap-x-3 ${searchInputVisible ? "py-0.5 px-1 border dark:bg-inherit bg-gray-50 rounded-md max-w-[700px] p-2.5 ml-3 search--input--width--animation" : ""}`}>
